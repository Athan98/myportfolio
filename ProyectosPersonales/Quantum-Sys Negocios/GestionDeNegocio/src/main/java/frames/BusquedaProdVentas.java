...
public class BusquedaProdVentas extends javax.swing.JInternalFrame {
    ...
    private void jbAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbAgregarActionPerformed
        try {
            ...
            if (filaSeleccionada != (-1)) {
                ...
                Ventas.jtCodigo.setText(prod.getCodigo());
                Ventas.jtNombre.setText(prod.getNombre());
                Ventas.enterPresionado = true;
                Ventas.jtCantidad.requestFocus();
    ...
    public void armarCabeceraTabla() {
        ...
        jtProductos.setDefaultRenderer(Object.class, new RenderProductosBuscadosVentas());
        ...
        modelo.addColumn("$ Venta unitario");
