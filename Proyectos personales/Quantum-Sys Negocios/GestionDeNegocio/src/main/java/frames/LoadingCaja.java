...
public class LoadingCaja extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        panelBack.setBackground(new java.awt.Color(63, 34, 66));
        panelBack.setForeground(new java.awt.Color(63, 34, 66));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LoadingCaja.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LoadingCaja().setVisible(true);
            }
        });
    }
